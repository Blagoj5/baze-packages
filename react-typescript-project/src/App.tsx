  ...
  return (
    <div>
      ...
      <p>
        ...
        many web sites still in their infancy. Various versions have ev olved
        over the years, sometimes by accident, sometimes on purpose (injected
        humour and the like)
      </p>
      <h1 id='test'>
        Where does it come from? <b>ID: #test</b>
      </h1>
      <p>
      ...
      <div className={styles.ShowMoreDiv}>
        <ShowMore defaultAnchor className={styles.Tester}>
          ...
          <h3>Green color</h3>
          <p>
            <b>Green color</b> is the button's container/div. Props: style=
            {'{{background: "orange", justifyContent: "left"}}'}
          </p>
          <h3>Purple color</h3>
          <p>
            <b>Purple color</b> is the button itself. Props: style=
            {'{{background: "purple}}"'}{' '}
          </p>
          <p>
            Lorem Ipsum is simply dummy text of the printing and typesetting
